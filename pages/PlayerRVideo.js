...
const PlayerRVideo = (props) => {
  ...
  var toploadingbarref = props.toploadingbarref;
  // var setprogress = props.setprogress;
    ...
    if (datasecboxpro.streamable) {
      ...
      if (datasecboxpro1.data.streamable) {
        ...
        setfullplayerconfig((dat) => ({
          ...
          url:
            typeof datasecboxpro1.data.data == "array"
              ? datasecboxpro1.data.data[0]
